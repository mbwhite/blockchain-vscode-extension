...
import { exportRuntimeConnectionProfile } from './commands/exportRuntimeConnectionProfile';
...
export function registerCommands(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('blockchainExplorer.exportRuntimeConnectionProfile', (runtimeTreeItem?: RuntimeTreeItem) => exportRuntimeConnectionProfile(runtimeTreeItem)));
